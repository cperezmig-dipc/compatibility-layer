...
./install_compatibility_layer.sh -a ${eessi_arch} -r ${eessi_repo} -g ${STORAGE} -v ${job_version} -c docker://ghcr.io/eessi/bootstrap-prefix:debian-13 -k --verbose 2>&1 | tee -a ${script_out}
